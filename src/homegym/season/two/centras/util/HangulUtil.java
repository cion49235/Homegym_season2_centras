 ...
 */
package homegym.season.two.centras.util;
...
public class HangulUtil {
	...
	public static String getHangulInitialSound(String subject,
			String searchKeyword) {
		return getHangulInitialSound(subject, getIsChoSungList(searchKeyword));
	}

	public static String getHangulInitialSound(String subject, boolean[] isChoList) {

		StringBuffer result = new StringBuffer();
		int[] unicodeList2 = convertStringToUnicode(subject);
		for (int idx = 0; idx < unicodeList2.length; idx++) {
			int unicode = unicodeList2[idx];
	...
	public static void main(String[] args) {
		...
		for (char ch : HangulUtil.INITIAL_SOUND) {
			System.out.print(HangulUtil.convertCharToUnicode(ch) + ",");
		}
	}
}
